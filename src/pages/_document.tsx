  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:title" content="Yums.fun - Launch your Solana token in seconds" />
        ...
        <meta property="og:image" content="https://yums.fun/og-image.png" />
        <meta property="og:url" content="https://yums.fun" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Yums.fun - Launch your Solana token in seconds" />
        ...
        <meta name="twitter:image" content="https://yums.fun/og-image.png" />
